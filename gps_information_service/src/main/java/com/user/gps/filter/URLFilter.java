...
public class URLFilter implements Filter {
    ...
    // url's reg expression
    private static final String[] excludeUrls = {".*swagger.*", ".*api-docs.*"};
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        for (String excludeUrl : excludeUrls) {
            if (Pattern.matches(excludeUrl, httpServletRequest.getRequestURI()) ) {
        ...
        try {
            log.info(httpServletRequest.getRequestURI() + " ---------------------------- start");
            if (null != httpServletRequest.getQueryString()) {
                log.info(httpServletRequest.getQueryString());
            }
            log.info(bufferedRequestWrapper.getRequestBody());
            filterChain.doFilter(bufferedRequestWrapper, servletResponse);
        } finally {
            log.info( httpServletRequest.getRequestURI() + " ---------------------------- end [time:" + (System.currentTimeMillis()-begin) + "]\r\n");
        }
